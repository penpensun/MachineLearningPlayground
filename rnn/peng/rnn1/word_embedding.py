...
def training():
    global batch_size;
    global embedding_size; #Dimension of the embedding vector
    global skip_window; #How many words to consider left and right;
    global num_skips; #How many times to reuse an input to generate a label
    #
    global valid_size;
    global valid_window;
    ...
    with graph.as_default(), tf.device('/cpu:0'):
        ...
        #Compute the similarity between minibatch example and all embededings.
        ...
        for step in range(num_steps):
            ...
            if step % 5000 == 0:
                ...
                for i in range(valid_size):
                    ...
                    print(log);
            '''
        final_embedding = normalized_embeddings.eval(); #Compute the final word embeddings.
